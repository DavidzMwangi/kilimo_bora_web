...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>K</b>LB</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Kilimo</b>Bora</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{date('Y')}} <a href="http://neverest.co.ke">Neverest LTD</a>.</strong> All rights
        reserved.
    </footer>
