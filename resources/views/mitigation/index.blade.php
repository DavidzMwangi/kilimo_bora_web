            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{route('new_mitigation')}}" method="post" >
                                    {{csrf_field()}}
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea placeholder="Enter the mitigation plan"  id="mitigation_plan" name="mitigation_plan" class="form-control" required>
